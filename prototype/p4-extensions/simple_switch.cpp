...
REGISTER_HASH(my_hash11);
REGISTER_HASH(my_hash12);
REGISTER_HASH(my_hash13);
REGISTER_HASH(my_hash14);
REGISTER_HASH(my_hash15);
REGISTER_HASH(my_hash16);
REGISTER_HASH(my_hash17);
REGISTER_HASH(my_hash18);
REGISTER_HASH(my_hash19);
REGISTER_HASH(my_hash20);
REGISTER_HASH(my_hash21);
REGISTER_HASH(my_hash22);
