...
struct Algorithm_Model : public ::Model::Enum_Model {
    Algorithm_Model() : ::Model::Enum_Model("HashAlgorithm"),
			...
			my_hash1("my_hash1"),my_hash2("my_hash2"),my_hash3("my_hash3"),my_hash4("my_hash4"),my_hash5("my_hash5"),my_hash6("my_hash6"),
			my_hash7("my_hash7"),my_hash8("my_hash8"),my_hash9("my_hash9"),my_hash10("my_hash10") {}
    ::Model::Elem crc32;
