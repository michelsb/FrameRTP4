...
#         degree = 0
#         arrayChar = list(key)
#         for i in range(0,len(arrayChar),2):
#             if arrayChar[i] == "1":
#                 arrayChar[i] = "0"
#             else:
#                 arrayChar[i] = "1"
...
def wild_card_search(binaryWild, hashElement, maxWild, solution):
    ...
    #hashKeys = {}
    #entries=int(math.pow(2,maxWild))

    #for wild_solution in provisorySolution:
    #    auxHashKeys = {}
    #    totalMatches = 0
    #    for
...
def generate_values_with_wildcards(bin_list, size):
    ...
    #for value in bin_list[:10]:
    #    print hashBinaryElement[value]
